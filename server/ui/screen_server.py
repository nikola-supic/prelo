...
"}")
        ...
        self.label_host = QtWidgets.QLabel(self.widget)
        self.label_host.setGeometry(QtCore.QRect(450, 15, 160, 30))
        font = QtGui.QFont()
        font.setFamily("Courier")
        font.setPointSize(10)
        self.label_host.setFont(font)
        self.label_host.setStyleSheet("color: rgb(224,224,226);")
        ...
        self.label_port.setGeometry(QtCore.QRect(450, 35, 160, 30))
        font = QtGui.QFont()
        font.setFamily("Courier")
        font.setPointSize(10)
    ...
    def retranslateUi(self, ServerScreen):
        ...
        self.label_host.setText(_translate("ServerScreen", "Host: localhost"))
        self.label_port.setText(_translate("ServerScreen", "Port: 5555"))
import res_rc
